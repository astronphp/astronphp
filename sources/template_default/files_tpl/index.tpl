  ...
  <body id="home">
	...
	<div class="row col-12 mx-auto py-2">
		<div class="col-md-6 col-sm-12">
			<a href="{{base_url}}">
				<img src="./template_default/assets/media/icon.png?cbh=b8dc5b0f826fad3c2a2685bea1bc00a3" class="logo">
			</a>
		</div>
		<div class="col-md-6 col-sm-12">
	...
	<a href="https://github.com/astronphp" target="_blank" class="btn btn-info mt-3 py-3 px-4">Last version - Astronphp {{version}} May, 2019</a>
</div>
    </div>
    ...
    <div class="row col-md-8 col-sm-12 mx-auto mt-3 col-sm-12 content-page">
        <ul class="cards">
            ...
            <li class="col-md-3 col-sm-6 p-2">
              <a href="https://github.com/astronphp/framework/" target="_blank" href="#" class="px-1 py-3 col-12">
                  <div class="col-12">
            ...
            <li class="col-md-3 col-sm-6 p-2">
                <a href="https://github.com/astronphp/orm/" target="_blank" class="px-1 py-3 col-12">
                    <div class="col-12">
            ...
            <li class="col-md-3 col-sm-6 p-2">
                <a href="https://github.com/astronphp/viewfront/" target="_blank" class="px-1 py-3 col-12">
                  <div class="col-12">
...
<p class="text-center mx-auto font_12 mt-5">Copyright © - 2019</p>
    ...
    <script src="./template_default/assets/vendor/jquery/jquery.min.js?cbh=220afd743d9e9643852e31a135a9f3ae"></script>
    <script src="./template_default/assets/js/main.min.js?cbh=12c3ad327c774fa02fd76467fb652794"></script>
  </body>
</html>